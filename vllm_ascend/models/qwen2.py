...
from vllm.model_executor.models.qwen2 import (Qwen2DecoderLayer,  # noqa: F401
...
class CustomQwen2Model(nn.Module):
    ...
    def __init__(
        ...
        decoder_layer_type = CustomQwen2DecoderLayer
    ...
    def forward(
        ...
        for layer in self.layers[self.start_layer:self.end_layer]:
            kv_c = kv_caches[i - self.start_layer] if kv_caches is not None else None
